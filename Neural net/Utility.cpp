...
*/
class Utility {
	void static displayPNGInfo(const LodePNGInfo& info)
	{
	...
	*/
	void static displayChunkNames(const std::vector<unsigned char>& buffer)
	{
	...
	*/
	void static displayAsciiArt(const std::vector<unsigned char>& image, unsigned w, unsigned h)
	{
		if (w > 0 && h > 0)
		{
	...
	*/
	void static displayFilterTypes(const std::vector<unsigned char>& buffer, bool ignore_checksums)
	{
