...
Util::~Util()
{
 ...
 void  Util::displayPNGInfo(const LodePNGInfo& info)
	{
	...
	*/
 void  Util::displayChunkNames(const std::vector<unsigned char>& buffer)
	{
	...
	*/
	void  Util::decode(const std::vector<unsigned char>& image, unsigned w, unsigned h, array<array<int,28>,28>& tab)
	{
		if (w > 0 && h > 0)
		{
	...
	*/
	void  Util::displayFilterTypes(const std::vector<unsigned char>& buffer, bool ignore_checksums)
	{
